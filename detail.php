...
?>
      ...
      <section class="py-5">
        <div class="container">
                    <?php
                      $id=$_GET['id'];
                      $q=$conn->query("SELECT * FROM product where id='$id'");
                      $res=$q->fetch_assoc();
                      $last_view=$res['view'];
                      $last_view=$last_view+1;
                      $conn->query("UPDATE product SET view='$last_view' WHERE id='$id'");
                    ?>
          <div class="row mb-5">
            <div class="col-lg-6">
              <!-- PRODUCT SLIDER-->
              <div class="row m-sm-0">
                <div class="col-sm-2 p-sm-0 order-2 order-sm-1 mt-2 mt-sm-0">
                  <div class="owl-thumbs d-flex flex-row flex-sm-column" data-slider-id="1">
                    ...
                    <div class="owl-thumb-item flex-fill mb-2 mr-2 mr-sm-0"><img class="w-100" src="admin/images/<?php echo $images['images'] ?>" alt="..."></div>
                ...
                <div class="col-sm-10 order-1 order-sm-2">
                  ...
                  <?php
                    ...
                    ?>
                    <a class="d-block" href="admin/images/<?php echo $images['images'] ?>" data-lightbox="product" title="Product item 1"><img class="img-fluid" src="admin/images/<?php echo $res['images'] ?>" alt="..."></a>
                  <?php
                    }
                  ?>
            ...
            <div class="col-lg-6">
              <ul class="list-inline mb-2">
                <?php
                    ...
                    <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
                    <?php
                    }elseif($last_view>=20 && $last_view<40){
                      ?>
                      <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
                      <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
                      <?php
                    }elseif($last_view>=40 && $last_view<60){
                      ?>
                      <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
                      <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
                      <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
                      <?php
                    }elseif($last_view>=60 && $last_view<80){
                      ?>
                      <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
                      <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
                      <li class="list-inline-item m-0"><i class="fas fa-star small text-warning"></i></li>
              ...
              <p class="text-muted lead">$<?php echo $res['price'] ?></p>
              <p class="text-small mb-4"><?php echo $res['descr'] ?></p>
              <div class="row align-items-stretch mb-4">
                ...
                <div class="col-sm-3 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="fun/add_cart.php?id=<?php echo $res['id'] ?>">Add to cart</a></div>
              ...
              <ul class="list-unstyled small d-inline-block">
                ...
                <?php
                $id_cat=$res['cat_id'];
                  $q=$conn->query("SELECT * FROM category WHERE id = '$id_cat'");
                  while($res1=$q->fetch_assoc()){

                ?>

                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">Category:</strong><a class="reset-anchor ml-2" href="shop.php?id=<?php echo $res1['id'] ?>&page=1"><?php echo $res1['name'] ?></a></li>

                    <?php } ?>
                
                <li class="px-3 py-2 mb-1 bg-white text-muted"><strong class="text-uppercase text-dark">View:</strong><a class="reset-anchor ml-2"><?php echo $res['view'] ?></a></li>
              </ul>
            </div>
          </div>
          <!-- DETAILS TABS-->
              ...
              <div class="p-4 p-lg-5 bg-white">
                <div class="row">
                  ...
                  <?php
                    ...
                    ?>
                    <div class="media mb-3"><img class="rounded-circle" style="height: 80px;width:80px;object-fit:contain;"  src="" alt="aa" width="50">
                      <div class="media-body ml-3">
                        ...
                        <p class="text-small mb-0 text-muted"><?php echo $c['comment'] ?>.</p>
                      </div>
                    </div>
