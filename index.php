      ...
      <div class="container">
        ...
        <section class="pt-5">
          ...
          <div class="row">
            ...
            <?php
            $quary=$conn->query("SELECT * FROM product");
            while($res=$quary->fetch_assoc()){
            ?>

            <div class="col-md-4 mb-4 mb-md-0"><a class="category-item" href="shop.php"><img class="img-fluid" src="admin/images/<?php echo $res['images'] ?>" alt=""><strong class="category-item-title"><?php echo $res['name'] ?></strong></a></div>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product text-center">
                <div class="position-relative mb-3">
                  <div class="badge text-white badge-"></div><a class="d-block" href="detail.php?id=<?php echo $res1['id'] ?>"><img class="img-fluid w-100" src="admin/images/<?php echo $res1['images'] ?>" alt="..."></a>
                ...
                <h6> <a class="reset-anchor" href="detail.php?id=<?php echo $res1['id'] ?>"><?php echo $res1['descr'] ?></a></h6>
                <p class="small text-muted">$<?php echo $res1['price'] ?></p>
              </div>
            </div>
            <?php
              }
